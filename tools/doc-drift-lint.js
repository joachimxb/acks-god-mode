...
// carry a stale hardcoded set. Proves every engine module still loads, as a bonus. The removed-set
// below is built from the CHANGELOG + EXPLICIT_REMOVED; the engine load is for parity with the
// broad linter and future engine-truth checks.
global.window = global;
global.ACKS = global.ACKS || {};
require(path.join(REPO, 'tests', '_engine.js')).load();

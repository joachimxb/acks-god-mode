...
(function(){
  ...
  partyModalId: null,
  partyModalTab: 'manage',   // 'manage' | 'travel' | 'provisioning' | 'camp' | 'chronicle' — the modal's five tabs (the day log lives inside Travel)
  openPartyModal(partyId, tab){
    ...
    this.partyModalTab = ['manage','travel','provisioning','camp','chronicle'].includes(tab) ? tab : 'manage';

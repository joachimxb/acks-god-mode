  ...
  "lairs": [
    {
      "schemaVersion": 2,
      "id": "lai-greypack-den",
      "name": "The Grey Pack's Den",
      "status": "active",
      "hexId": "hex-wolfden-hills",
      "precisePlacement": "a cairn-hill den above the Northwatch droves",
      "knownToPlayers": true,
      "hiddenDC": null,
      "monsterCatalogKey": "dire-wolf",
      "lairPct": null,
      ...
      "leaderCharacterIds": [],
      "totalInhabitantCount": 0,
      "treasureType": "",
      "treasureCustodyId": null,
      "lairType": "natural-cave",
      "terrain": "hills",
      "hasFortifications": false,
      "features": [],
      "factionKey": null,
      "establishedAtTurn": 1,
      "establishedBy": "genesis",
      "lastVisitedTurn": null,
      "clearedAtTurn": null,
      "clearedByEventId": null,
      "repopulationChance": null,
      "discoveryHistory": [],
      "notes": "The Grey Pack dens in the old cairn-hills and takes calves — and in hard winters herders — from the Northwatch pastures. Baron Yorick has lost three drives to them.",
      "history": []
    },
    {
      "schemaVersion": 2,
      "id": "lai-merefolk-causeway",
      "name": "The Drowned Causeway",
      "status": "active",
      "hexId": "hex-saltmarsh",
      "precisePlacement": "the drowned Auran causeway under the marsh",
      "knownToPlayers": true,
      "hiddenDC": null,
      "monsterCatalogKey": "lizardman",
      "lairPct": null,
      ...
      "repopulationChance": null,
      "discoveryHistory": [],
      "notes": "The Mere-Folk hold the drowned Auran causeway and trade only in salvaged bronze. Tidewrack leaves them a tribute of iron to keep the marsh-path open.",
      "history": []
    },
    {
      "schemaVersion": 2,
      "id": "lai-deepwood-weavers",
      "name": "The Weaver Deeps",
      "status": "active",
      "hexId": "hex-deepwood",
      "precisePlacement": "the webbed dark trees on the south flank of the pass",
      "knownToPlayers": true,
      "hiddenDC": null,
      "monsterCatalogKey": "giant-spider",
      "lairPct": null,

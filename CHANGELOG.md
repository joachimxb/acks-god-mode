...
### Fixed
- **A lost party could never reach its destination.** A successful navigation throw didn't clear the “lost” state, so once a party got lost it made zero progress every day despite succeeding. A success now re-orients the party (RR p.275 recovery) and travel resumes. The Journey Detail panel also shows **total and remaining distance** (e.g. “Distance: 12 mi total · 0 mi left · 2/2 hexes”).

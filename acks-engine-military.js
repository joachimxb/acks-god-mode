 ...
 * _levyMusterNoun, _completeTraining, _musterDestinationHexId and the F&D troop-bridge
 * privates are exported for their engine-core callers (favor-duty / muster / training).
...
Object.assign(ACKS, {
  ...
  // levy muster/training/destination, domain-resolve); were engine-private, now reached via ACKS.*.
  _resolveDomain, _levyMusterNoun, _completeTraining, _musterDestinationHexId, _favorDutyMaterializeTroops, _favorDutyDematerializeTroops
});
